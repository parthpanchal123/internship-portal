...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="pt-3 text-center text-muted">My Posted Internships</h3>
            </div>
        </div>
        <?php 
        $sql = "SELECT *, i.id as internship_id FROM internships i INNER JOIN employers e ON i.posted_by = e.id WHERE e.id = $employer_id";
                ...
                <div class="col-md-10 m-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <a class="text-info" href="post-internship.php">POST INTERNSHIP NOW</a>
                        </div>
                    </div>
                </div>
            </div>';
