...
(1, 1, 'Belai', 'Chhattisgarh', 193121),
(2, 2, 'Kripal Pora Payeen Singhpora', 'Baramulla, Kashmir', 193121);
...
CREATE TABLE `students` (
  `id` int(11) NOT NULL,
  `first_name` varchar(152) NOT NULL,
  `last_name` varchar(152) DEFAULT NULL,
...
(1, 'Anupam', 'Sahu', 'anupam@gmail.com', '$2y$10$aFLpfldMgN66e6L.ryixAemNX//RKnTyNoq9Ip55P1H0C0t3AsB7S', 'male', '9906578624', 'I have developed many projects including my portfolio, dashboard etc', '2019-09-18 12:21:08'),
(2, 'Muzaffar Hussain', 'Bhat', 'muzafar@gmail.com', '$2y$10$NLZ.oa5IKliFIq8nCKUD8eTWinI5JJ2L7ExQSf05hPCk1iEbDEiri', 'male', '9906578625', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus voluptatum ducimus vero odio quasi, laboriosam tempora nesciunt? Suscipit natus amet magnam numquam quas? Eius labore ipsam doloribus nulla cum totam?', '2019-09-18 18:16:45');
